...
class TranslationsUtils {
  ...
  /// Singleton Factory
  ///
  static final TranslationsUtils _translations = new TranslationsUtils._internal();
  factory TranslationsUtils() {
    return _translations;
  }
  TranslationsUtils._internal();
}

TranslationsUtils translationsUtils = new TranslationsUtils();